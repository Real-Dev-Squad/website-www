...
- You can check for any **unassigned** [issues](https://github.com/Real-Dev-Squad/website-www/issues) and **comment** on that issue that you'd like to get that issue assigned to you. (Remember: Do not work on issues assigned to someone else and do not work on any issue without having it assigned to you.)
...
![how-to-fork](https://user-images.githubusercontent.com/53713926/212477154-9d9b0afb-c692-4b75-bbf1-822e940f9061.png)
...
If it's been quite a while after you have cloned the repo/made the last pull request, it's recommended to take a pull from the develop-ember branch. Reason being, there may be some changes which could have merged after you had cloned the repo/made the last pull request.
...
It may so happen that since the last time you cloned the repo/took a pull from develop, some changes may be merged in the develop-ember branch. So to be on the safer side, we should have those changes as well.

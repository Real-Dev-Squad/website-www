...
export default class NewSignupController extends Controller {
  ...
  // replace this signupDev flag with dev flag once new-signup page is not under dev flag
  get useSignupDev() {
